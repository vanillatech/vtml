...
/*for ($l=0;$l<strlen($chars);$l++) {  
  ...
  $query1 = "INSERT INTO activationQueue (neuronid, activationVal, activationDelay) VALUES (" . $charsid[$l] . ",1,1)";
  $result = mysql_query($query1,$db);
} //keine zeichen mehr 
...
?>
<form name=mouth action="index8.php" method="get">
