...
//change index17e.php: newneuron: auch einzelne neuronen anlegen (mit nur einem vorgänger)
...
function newNeuron () {
    ...
    $query1 = "SELECT * FROM recoveryQueue WHERE fireorder = 1 AND layer NOT IN (SELECT layer FROM recoveryQueue WHERE fireorder = 0) GROUP BY layer ORDER BY layer ASC";
    ...
    $query1 = "SELECT * from recoveryQueue WHERE layer = $layerid order by fireorder";
